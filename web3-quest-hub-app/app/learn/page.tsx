      ...
      <main className="flex flex-1 justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-7xl">
          <div className="mb-8 text-center">
            <h1 className="text-4xl font-bold tracking-tighter text-[var(--primary)] sm:text-5xl">Learn</h1>
            <p className="mt-2 text-theme-secondary">Educational resources to master Web3 technology</p>
          </div>
          ...
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              ...
              <p className="text-theme-secondary">Learning resources are under development</p>
            </div>
          </div>
        </div>
      </main>
